...
if __name__ == "__main__":
    ...
    output_file = f"DrivenPath/chapter_2/work_2/data_2/batch_{date.today()}.csv"

    # Define number of records: first run - 100_372; next runs random number.
    if str(date.today()) == "2025-04-09":
